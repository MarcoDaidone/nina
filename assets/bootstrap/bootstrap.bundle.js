...
!(function (global, factory) {
     ...
     'use strict';
     const getSelector = (element) => element.getAttribute('data-bs-target'),
          ...
          getjQuery = () => {
               ...
               return jQuery && !document.body.hasAttribute('data-bs-no-jquery')
                    ? jQuery
                    : null;
          },
          ...
          getNextActiveElement = (
               ...
               return (
                    ...
                    list[Math.max(0, Math.min(index, listLength - 1))]
               );
          },
          namespaceRegex = /[^.]*(?=\..*)\.|.*/,
          stripNameRegex = /\..*/,
     ...
     function normalizeParams(originalTypeEvent, handler, delegationFn) {
          ...
          return (
               nativeEvents.has(typeEvent) || (typeEvent = originalTypeEvent),
               [delegation, originalHandler, typeEvent]
          );
     }
     function addHandler(
          element,
          ...
          if (
               ...
               customEventsRegex.test(originalTypeEvent))
          ) {
               const wrapFn = (fn) =>
                    function (event) {
                         if (
          ...
          const [delegation, originalHandler, typeEvent] = normalizeParams(
               ...
               previousFn = findHandler(
                    handlers,
                    originalHandler,
                    delegation ? handler : null
               );
          if (previousFn)
               return void (previousFn.oneOff = previousFn.oneOff && oneOff);
     ...
     const EventHandler = {
          ...
          Data = {
               set(element, key, instance) {
                    ...
                    instanceMap.has(key) || 0 === instanceMap.size
     ...
     class BaseComponent {
          ...
          static getOrCreateInstance(element, config = {}) {
               return (
                    ...
                    new this(element, 'object' == typeof config ? config : null)
               );
          }
          static get VERSION() {
               return '5.1.3';
     ...
     class Alert extends BaseComponent {
          ...
          close() {
               if (
                    EventHandler.trigger(this._element, 'close.bs.alert')
                         .defaultPrevented
               )
                    return;
          ...
          _destroyElement() {
               this._element.remove(),
                    EventHandler.trigger(this._element, 'closed.bs.alert'),
                    this.dispose();
          }
     ...
     EventHandler.on(
          ...
          (event) => {
               event.preventDefault();
               const button = event.target.closest('[data-bs-toggle="button"]');
     ...
     const Manipulator = {
          ...
          SelectorEngine = {
               ...
               findOne: (selector, element = document.documentElement) =>
                    Element.prototype.querySelector.call(element, selector),
               ...
               parents(element, selector) {
                    ...
                    for (
                         ...
                         ancestor.matches(selector) && parents.push(ancestor),
     ...
     class Carousel extends BaseComponent {
          ...
          _getConfig(config) {
               return (
                    ...
                    typeCheckConfig('carousel', config, DefaultType$a),
                    config
               );
          }
          _handleSwipe() {
          ...
          _slide(directionOrOrder, element) {
               const order = this._directionToOrder(directionOrOrder),
                    activeElement = SelectorEngine.findOne(
                         '.active.carousel-item',
                         this._element
                    ),
          ...
          _directionToOrder(direction) {
               return [DIRECTION_RIGHT, DIRECTION_LEFT].includes(direction)
                    ? isRTL()
          ...
          _orderToDirection(order) {
               return [ORDER_NEXT, ORDER_PREV].includes(order)
                    ? isRTL()
                         ? order === ORDER_PREV
                              ? DIRECTION_LEFT
                              : DIRECTION_RIGHT
          ...
          static dataApiClickHandler(event) {
               ...
               slideIndex && (config.interval = !1),
                    ...
                    slideIndex && Carousel.getInstance(target).to(slideIndex),
                    event.preventDefault();
          }
     }
     EventHandler.on(
     ...
     class Collapse extends BaseComponent {
          ...
          show() {
               ...
               if (
                    EventHandler.trigger(this._element, 'show.bs.collapse')
                         .defaultPrevented
               )
                    return;
               actives.forEach((elemActive) => {
                    container !== elemActive &&
                         Collapse.getOrCreateInstance(elemActive, {
                              toggle: !1,
                         }).hide(),
                         activesData ||
                              Data.set(elemActive, 'bs.collapse', null);
               });
          ...
          hide() {
               if (this._isTransitioning || !this._isShown()) return;
               if (
                    EventHandler.trigger(this._element, 'hide.bs.collapse')
                         .defaultPrevented
               )
                    return;
               const dimension = this._getDimension();
          ...
          _getConfig(config) {
               return (
                    ((config = {
                         ...
                         ...Manipulator.getDataAttributes(this._element),
                         ...config,
                    }).toggle = Boolean(config.toggle)),
                    (config.parent = getElement(config.parent)),
                    typeCheckConfig('collapse', config, DefaultType$9),
                    config
               );
          }
          _getDimension() {
               ...
               var fn,
                    ...
                    instance = {
                         ...
                         setOptions: function (setOptionsAction) {
                              ...
                              var modifiers,
                                   merged,
                                   orderedModifiers = (function (modifiers) {
                                        ...
                                        (merged = modifiers.reduce(function (
                                             merged,
                                             current
                                        ) {
                                             var existing =
     ...
     class Dropdown extends BaseComponent {
          ...
          _getConfig(config) {
               if (
                    ...
                    'object' == typeof config.reference &&
          ...
          _createPopper(parent) {
               ...
               const popperConfig = this._getPopperConfig(),
                    isDisplayStatic = popperConfig.modifiers.find(
                         (modifier) =>
                              'applyStyles' === modifier.name &&
                              !1 === modifier.enabled
                    );
          ...
          _getPlacement() {
               ...
               const isEnd =
                    ...
                    getComputedStyle(this._menu)
                         ...
                         .trim();
               return parentDropdown.classList.contains('dropup')
                    ? isEnd
                         ? PLACEMENT_TOPEND
                         : PLACEMENT_TOP
                    : isEnd
          ...
          _getOffset() {
               ...
               return 'string' == typeof offset
                    ? offset.split(',').map((val) => Number.parseInt(val, 10))
                    : 'function' == typeof offset
                    ? (popperData) => offset(popperData, this._element)
                    : offset;
          }
          _getPopperConfig() {
          ...
          static clearMenus(event) {
               if (
                    event &&
                    (2 === event.button ||
                         ('keyup' === event.type && 'Tab' !== event.key))
               )
                    return;
               const toggles = SelectorEngine.find(
               ...
               for (let i = 0, len = toggles.length; i < len; i++) {
                    ...
                    if (event) {
                         const composedPath = event.composedPath(),
                              isMenuTarget = composedPath.includes(
                                   context._menu
                              );
                         if (
                              composedPath.includes(context._element) ||
                              ('inside' === context._config.autoClose &&
                                   !isMenuTarget) ||
                              ('outside' === context._config.autoClose &&
                                   isMenuTarget)
                         )
                              continue;
                         if (
          ...
          static dataApiKeydownHandler(event) {
               ...
               if ('Escape' !== event.key)
                    return 'ArrowUp' === event.key || 'ArrowDown' === event.key
                         ? (isActive || instance.show(),
                           void instance._selectMenuItem(event))
                         : void (
                                (isActive && 'Space' !== event.key) ||
                                Dropdown.clearMenus()
                           );
               instance.hide();
          }
     ...
     class Backdrop {
          ...
          _getConfig(config) {
               return (
                    ((config = {
                         ...Default$7,
                         ...('object' == typeof config ? config : {}),
                    }).rootElement = getElement(config.rootElement)),
                    typeCheckConfig('backdrop', config, DefaultType$7),
                    config
               );
          }
          _append() {
          ...
          dispose() {
               this._isAppended &&
                    (EventHandler.off(this._element, 'mousedown.bs.backdrop'),
                    this._element.remove(),
                    (this._isAppended = !1));
          }
     ...
     class FocusTrap {
          ...
          activate() {
               const { trapElement: trapElement, autofocus: autofocus } =
                    this._config;
               this._isActive ||
                    (autofocus && trapElement.focus(),
                    EventHandler.off(document, '.bs.focustrap'),
                    EventHandler.on(document, 'focusin.bs.focustrap', (event) =>
          ...
          _handleFocusin(event) {
               const { target: target } = event,
                    { trapElement: trapElement } = this._config;
               if (
                    target === document ||
                    target === trapElement ||
          ...
          _getConfig(config) {
               return (
                    ...
                    typeCheckConfig('focustrap', config, DefaultType$6),
                    config
               );
          }
     }
     ...
     class Modal extends BaseComponent {
          ...
          show(relatedTarget) {
               ...
               EventHandler.trigger(this._element, 'show.bs.modal', {
                    relatedTarget: relatedTarget,
               }).defaultPrevented ||
                    ((this._isShown = !0),
          ...
          hide() {
               if (!this._isShown || this._isTransitioning) return;
               if (
                    EventHandler.trigger(this._element, 'hide.bs.modal')
                         .defaultPrevented
               )
                    return;
               this._isShown = !1;
               const isAnimated = this._isAnimated();
               isAnimated && (this._isTransitioning = !0),
                    this._setEscapeEvent(),
                    this._setResizeEvent(),
                    this._focustrap.deactivate(),
                    this._element.classList.remove('show'),
                    EventHandler.off(this._element, 'click.dismiss.bs.modal'),
                    EventHandler.off(
                         this._dialog,
                         'mousedown.dismiss.bs.modal'
                    ),
          ...
          dispose() {
               [window, this._dialog].forEach((htmlElement) =>
                    EventHandler.off(htmlElement, '.bs.modal')
               ),
          ...
          _getConfig(config) {
               return (
                    ...
                    typeCheckConfig('modal', config, DefaultType$5),
                    config
               );
          }
          _showElement(relatedTarget) {
               const isAnimated = this._isAnimated(),
                    modalBody = SelectorEngine.findOne(
                         '.modal-body',
                         this._dialog
                    );
               (this._element.parentNode &&
                    ...
                    isAnimated && reflow(this._element),
                    this._element.classList.add('show');
               this._queueCallback(
                    () => {
          ...
          _setEscapeEvent() {
               this._isShown
                    ? EventHandler.on(
                           ...
                           (event) => {
                                this._config.keyboard && 'Escape' === event.key
          ...
          _setResizeEvent() {
               this._isShown
                    ? EventHandler.on(window, 'resize.bs.modal', () =>
                           this._adjustDialog()
                      )
          ...
          _triggerBackdropTransition() {
               ...
               (!isModalOverflowing && 'hidden' === style.overflowY) ||
                    classList.contains('modal-static') ||
     ...
     class Offcanvas extends BaseComponent {
          ...
          show(relatedTarget) {
               ...
               if (
                    EventHandler.trigger(this._element, 'show.bs.offcanvas', {
                         relatedTarget: relatedTarget,
                    }).defaultPrevented
               )
                    return;
          ...
          hide() {
               if (!this._isShown) return;
               if (
                    EventHandler.trigger(this._element, 'hide.bs.offcanvas')
                         .defaultPrevented
               )
                    return;
               this._focustrap.deactivate(),
          ...
          _getConfig(config) {
               return (
                    ...
                    typeCheckConfig('offcanvas', config, DefaultType$4),
                    config
               );
          }
          _initializeBackDrop() {
     ...
     EventHandler.on(
          ...
          function (event) {
               ...
               const allReadyOpen = SelectorEngine.findOne('.offcanvas.show');
               allReadyOpen &&
                    allReadyOpen !== target &&
          ...
          EventHandler.on(window, 'load.bs.offcanvas.data-api', () =>
               SelectorEngine.find('.offcanvas.show').forEach((el) =>
     ...
     class Tooltip extends BaseComponent {
          ...
          show() {
               ...
               tip.setAttribute('id', tipId),
                    ...
                    this._config.animation && tip.classList.add('fade');
               const placement =
               ...
               customClass && tip.classList.add(...customClass.split(' ')),
                    'ontouchstart' in document.documentElement &&
                         []
                              .concat(...document.body.children)
                              .forEach((element) => {
               ...
               this._queueCallback(
                    () => {
                         this._isWithActiveTrigger() ||
                              ('show' !== this._hoverState && tip.remove(),
                              this._cleanTipClass(),
          ...
          setElementContent(element, content) {
               if (null !== element)
                    return isElement$1(content)
                         ? ((content = getElement(content)),
                           void (this._config.html
                                ? content.parentNode !== element &&
                                  ((element.innerHTML = ''),
          ...
          _getPopperConfig(attachment) {
               const defaultBsPopperConfig = {
                    ...
                    onFirstUpdate: (data) => {
                         data.options.placement !== data.placement &&
                              this._handlePopperPlacementChange(data);
                    },
               };
               return {
          ...
          _fixTitle() {
               const title = this._element.getAttribute('title'),
                    originalTitleType = typeof this._element.getAttribute(
                         'data-bs-original-title'
                    );
               (title || 'string' !== originalTitleType) &&
                    (this._element.setAttribute(
                         'data-bs-original-title',
                         title || ''
                    ),
          ...
          _enter(event, context) {
               (context = this._initializeOnDelegatedTarget(event, context)),
                    ...
                    context.getTipElement().classList.contains('show') ||
                    'show' === context._hoverState
                         ? (context._hoverState = 'show')
                         : (clearTimeout(context._timeout),
                           (context._hoverState = 'show'),
                           context._config.delay && context._config.delay.show
          ...
          _leave(event, context) {
               (context = this._initializeOnDelegatedTarget(event, context)),
                    ...
                    context._isWithActiveTrigger() ||
                         ...
                         context._config.delay && context._config.delay.hide
                              ? (context._timeout = setTimeout(() => {
                                     'out' === context._hoverState &&
                                          context.hide();
          ...
          _getConfig(config) {
               ...
               return (
                    Object.keys(dataAttributes).forEach((dataAttr) => {
                         DISALLOWED_ATTRIBUTES.has(dataAttr) &&
          ...
          _getDelegateConfig() {
               ...
               for (const key in this._config)
                    this.constructor.Default[key] !== this._config[key] &&
                         (config[key] = this._config[key]);
               return config;
          }
          _cleanTipClass() {
               const tip = this.getTipElement(),
                    basicClassPrefixRegex = new RegExp(
          ...
          _handlePopperPlacementChange(popperData) {
               ...
               state &&
                    ...
                    this._addAttachmentClass(
                         this._getAttachment(state.placement)
                    ));
          }
          _disposePopper() {
     ...
     class ScrollSpy extends BaseComponent {
               ...
               const autoMethod =
                    ...
                    offsetMethod =
                         'auto' === this._config.method
                              ...
                              : this._config.method,
                    offsetBase =
                         'position' === offsetMethod ? this._getScrollTop() : 0;
               (this._offsets = []),
                    (this._targets = []),
          ...
          dispose() {
               EventHandler.off(this._scrollElement, '.bs.scrollspy'),
                    super.dispose();
          }
          _getConfig(config) {
               return (
                    ...
                    typeCheckConfig('scrollspy', config, DefaultType$1),
                    config
               );
          }
          _getScrollTop() {
     ...
     EventHandler.on(window, 'load.bs.scrollspy.data-api', () => {
          SelectorEngine.find('[data-bs-spy="scroll"]').forEach(
     ...
     class Tab extends BaseComponent {
          ...
          show() {
               ...
               const hideEvent = previous
                    ? EventHandler.trigger(previous, 'hide.bs.tab', {
               ...
               const complete = () => {
                    EventHandler.trigger(previous, 'hidden.bs.tab', {
                         ...
                         EventHandler.trigger(this._element, 'shown.bs.tab', {
                              relatedTarget: previous,
                         });
               };
               target
          ...
          _activate(element, container, callback) {
               const active = (
                         ...
                         ('UL' !== container.nodeName &&
                              'OL' !== container.nodeName)
                              ? SelectorEngine.children(container, '.active')
                              : SelectorEngine.find(
                                     ':scope > li > .active',
                                     container
                                )
                    ...
                    isTransitioning =
                         callback &&
                         active &&
                         active.classList.contains('fade'),
                    complete = () =>
          ...
          _transitionComplete(element, active, callback) {
               if (active) {
                    ...
                    dropdownChild && dropdownChild.classList.remove('active'),
               ...
               if (
                    ...
                    parent && parent.classList.contains('dropdown-menu'))
               ) {
     ...
     class Toast extends BaseComponent {
          ...
          _setListeners() {
               EventHandler.on(this._element, 'mouseover.bs.toast', (event) =>
                    this._onInteraction(event, !0)
               ),
                    EventHandler.on(
                         this._element,
                         'mouseout.bs.toast',
                         (event) => this._onInteraction(event, !1)
                    ),
                    EventHandler.on(
                         this._element,
                         'focusin.bs.toast',
                         (event) => this._onInteraction(event, !0)
                    ),
                    EventHandler.on(
                         this._element,
                         'focusout.bs.toast',

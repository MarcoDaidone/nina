...
!(function (t, e) {
               ...
               V.find('.carousel-item img', this._element).forEach((t) => {
                    ...
                    this._pointerEvent
                         ? (j.on(
                           ...
                           j.on(this._element, 'pointerup.bs.carousel', (t) =>
                                n(t)
                           ),
                         ...
                         : (j.on(this._element, 'touchstart.bs.carousel', (t) =>
                           ...
                           j.on(this._element, 'touchmove.bs.carousel', (t) =>
                                i(t)
                           ),
     ...
     class un extends B {
          ...
          _enter(t, e) {
               (e = this._initializeOnDelegatedTarget(t, e)),
                    t &&
                         (e._activeTrigger['focusin' === t.type ? dn : hn] =
                              !0),
                    e.getTipElement().classList.contains(sn) ||
                    e._hoverState === on
                         ? (e._hoverState = on)
     ...
     class xn extends B {
          ...
          show() {
               ...
               if (i) {
                    const e =
                         'UL' === i.nodeName || 'OL' === i.nodeName ? Ln : kn;
